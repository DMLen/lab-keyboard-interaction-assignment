...
class Application(tk.Frame):
    ...
    def select_word_candidate(self, event):
        ...
        if 'SAVE' in btn.cget('text') or 'save' in btn.cget('text'):
            cmd = None
            cmd = messagebox.askyesno("Question","Do you want to use SAVE command?")
            if cmd is True:
                #copy function here
            ...
            cmd = None
            cmd = messagebox.askyesno("Question","Do you want to use UNDO command?")
            if cmd is True:
                #undo function here
            ...
            cmd = None
            cmd = messagebox.askyesno("Question","Do you want to use REDO command?")
            if cmd is True:
                #redo function here
        ...
        elif 'COPY' in btn.cget('text') or 'copy' in btn.cget('text'):
            cmd = None
            cmd = messagebox.askyesno("Question","Do you want to use COPY command?")
            if cmd is True:
                #save function here
                messagebox.showinfo("Message","Text copied!")
            else: 
